 ...
 */
public class VeryVerySimpleCongruenceAnalysisNT {
	...
	public VeryVerySimpleCongruenceAnalysisNT(File data, File one, File two, File work, String ID, TreeSet<String> taxaList){
		this.dataset = data;
	...
	public void go(){
		...
		parameters.put(BasemlParameters.TREEFILE, "treefile = "+this.treeFileOne.getAbsolutePath());
		...
		treeOnelnL = new DataSeries(ntDataSSLSlnL1,"nt lnL data - tree 1");
