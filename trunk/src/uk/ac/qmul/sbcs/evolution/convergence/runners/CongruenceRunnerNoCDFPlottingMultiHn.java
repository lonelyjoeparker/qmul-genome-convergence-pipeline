...
public class CongruenceRunnerNoCDFPlottingMultiHn {
	...
	public static void main(String[] args) {
		...
		taxaList.add("SOREX");
		MultiHnCongruenceAnalysisNoCDFPlotting analysis = new MultiHnCongruenceAnalysisNoCDFPlotting(dataSet, treeFileOne, treeFileTwo, treeFileThree, treeFileFour, workDir, binaries, runID, taxaList, replicatesForNull, thisFilter, doFactor);
			analysis.go();
	}
