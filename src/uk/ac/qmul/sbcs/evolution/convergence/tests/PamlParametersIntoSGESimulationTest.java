...
public class PamlParametersIntoSGESimulationTest extends TestCase {
	...
	public PamlParametersIntoSGESimulationTest(String name) {
		super(name);
	}
	...
	public void testSimulateNucleotides(){
		...
		EvolverSimulationSGE es = new EvolverSimulationSGE(this.evolverBinaryDir,workDir,f,baseml.getOptimisedTree(),numberOfTaxa,numberOfSites,numberOfReplicates,SequenceCodingType.DNA);
...
//		new VerboseSystemCommand("cp -v "+System.getProperty("user.dir")+"/mc.paml /pamlTest/testSimulationsFromParamsNucleotides.out");
	...
	public void testSimulateAminoAcids(){
		...
		EvolverSimulationSGE es = new EvolverSimulationSGE(workDir,f,tree,numberOfTaxa,numberOfSites,numberOfReplicates,SequenceCodingType.AA);
		es.initialiseSimulation();
...
//		new VerboseSystemCommand("cp -v "+System.getProperty("user.dir")+"/mc.paml /pamlTest/testSimulationsFromParamsAminoAcids.out");
	...
	public void testSimulateCodons(){
		...
		EvolverSimulationSGE es = new EvolverSimulationSGE(evolverBinaryDir,workDir,f,tree,numberOfTaxa,numberOfSites,numberOfReplicates,SequenceCodingType.CODON);
		es.initialiseSimulation();
