...
public class CongruenceTestRunnerAAwithBinariesArgsPruningSimFiltersCDFs {
	...
	public static void main(String[] args) {
		...
		taxaList.add("SOREX");
		CongruenceAnalysisAAWithBinariesPruningSimulationFilteringCDFs analysis = new CongruenceAnalysisAAWithBinariesPruningSimulationFilteringCDFs(dataSet, treeFileOne, treeFileTwo, workDir, binaries, runID, taxaList, replicatesForNull, thisFilter, doFactor);
			analysis.go();
	}
