...
public class AamlAnalysis extends PamlAnalysis {
	...
	public AamlAnalysis(AlignedSequenceRepresentation[] datasets, File[] treefiles, TreeMap<AamlParameters,String> parameters){
	...
	public AamlAnalysis(AlignedSequenceRepresentation[] datasets, File[] treefiles, TreeMap<AamlParameters,String> parameters, String name){
		this.datasets = datasets;
		this.treefiles = treefiles;
		this.typedAamlParameters = parameters;
		this.name = name;
