...
public class CongruenceTestRunnerAAwithBinariesArgsPruningSimFilters {
	...
	public static void main(String[] args) {
		...
		taxaList.add("SOREX");
		CongruenceAnalysisAAWithBinariesPruningSimulationFiltering analysis = new CongruenceAnalysisAAWithBinariesPruningSimulationFiltering(dataSet, treeFileOne, treeFileTwo, workDir, binaries, runID, taxaList, replicatesForNull, thisFilter, doFactor);
			analysis.go();
	}
