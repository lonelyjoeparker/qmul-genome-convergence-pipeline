...
public class ResultsPrinterSimpleMetadata{
	...
	public ResultsPrinterSimpleMetadata(String arg12, String arg2, String maxtreesInt, String metaDataLocation) {
		...
		this.metadata = new File(metaDataLocation);
	}

	public ResultsPrinterSimpleMetadata(String arg12) {
		// TODO Auto-generated constructor stub
		this.arg1 = arg12;
		this.dir = new File(arg1);
		this.maxTrees = 0;
	...
	public ResultsPrinterSimpleMetadata() {
		// TODO Auto-generated constructor stub
	}
	...
	public static void main(String[] args) {
		...
		try {
			new ResultsPrinterSimpleMetadata(args[0], args[1], args[2], args[3]).go();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			new ResultsPrinterSimpleMetadata(args[0]).go();
			e.printStackTrace();
		}
	}
	...
	public HashMap<String,String> initMetadata(){
		...
		if(this.metadata.canRead()){
			ArrayList<String> unparsedData = new BasicFileReader().loadSequences(metadata, false, false);
			for(String locus:unparsedData){
				metadataMap.put(locus.split("\t")[0], locus);
			}
		}else{
			String[] unparsedData = {
