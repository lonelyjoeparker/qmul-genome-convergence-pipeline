...
public class PamlParametersIntoSimulationTest extends TestCase {
	...
	public void testSimulateNucleotides(){
		...
		EvolverSimulation es = new EvolverSimulation(workDir,f,baseml.getOptimisedTree(),numberOfTaxa,numberOfSites,numberOfReplicates,SequenceCodingType.DNA);
	...
	public void testSimulateCodons(){
		...
		EvolverSimulation es = new EvolverSimulation(workDir,f,tree,numberOfTaxa,numberOfSites,numberOfReplicates,SequenceCodingType.CODON);
		es.initialiseSimulation();
