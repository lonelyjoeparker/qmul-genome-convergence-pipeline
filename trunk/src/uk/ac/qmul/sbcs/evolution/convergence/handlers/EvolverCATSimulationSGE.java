 ...
 * @version 0.0.1
 */
public class EvolverCATSimulationSGE extends AbstractSequenceSimulation {
	...
	public EvolverCATSimulationSGE(){}

	public EvolverCATSimulationSGE(HashMap<String, String> truncatedNamesHash, String phylogeny, int sitesToSimulate, int replicates, SequenceCodingType sqt){
	 ...
	 */
	public EvolverCATSimulationSGE(File binary, File workingDir, File ctlFile, String phylogeny, int numTaxa, int sitesToSimulate, int replicates, SequenceCodingType sqt){
	...
	public EvolverCATSimulationSGE(File workingDir, File ctlFile, String phylogeny, int numTaxa, int sitesToSimulate, int replicates, SequenceCodingType sqt){
		this.workingDir = workingDir;
		this.phylogeny = phylogeny;
		this.numTaxa = numTaxa;
		this.sitesToSimulate = sitesToSimulate;
