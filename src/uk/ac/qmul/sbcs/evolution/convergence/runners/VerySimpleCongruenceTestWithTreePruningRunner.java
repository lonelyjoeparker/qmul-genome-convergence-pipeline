...
public class VerySimpleCongruenceTestWithTreePruningRunner {
	...
	public static void main(String[] args) {
		...
		taxaList.add("Sorex");
		VerySimpleCongruenceAnalysisWithTreePruning analysis = new VerySimpleCongruenceAnalysisWithTreePruning(dataSet, treeFileOne, treeFileTwo, workDir, runID, taxaList);
		analysis.go();
	}
