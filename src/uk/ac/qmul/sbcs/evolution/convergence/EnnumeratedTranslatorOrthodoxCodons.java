...
/**
 * Translates codons to amino acids. <b>Only</b> covers the most common triplets. Use EnnumeratedTranslatorFullCodons for all.
 * @author <a href="http://github.com/lonelyjoeparker">@lonelyjoeparker</a>
 * @since 5 Jul 2017
 * @version 0.1
 */
public class EnnumeratedTranslatorOrthodoxCodons {

	private static TreeMap<String, Character>translationLookup = new TreeMap<String,Character>();
	
	public EnnumeratedTranslatorOrthodoxCodons(){
	/*
