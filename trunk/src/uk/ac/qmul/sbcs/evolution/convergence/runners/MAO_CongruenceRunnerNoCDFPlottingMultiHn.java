...
public class MAO_CongruenceRunnerNoCDFPlottingMultiHn {
	...
	public static void main(String[] args) {
		...
		taxaList.add("RHAF");
		taxaList.add("RHFE");
		MultiHnCongruenceAnalysisNoCDFPlotting analysis = new MultiHnCongruenceAnalysisNoCDFPlotting(dataSet, treeFileH0, treeFileH1, treeFileH2, treeFileH3, workDir, binaries, runID, taxaList, replicatesForNull, thisFilter, doFactor);
		analysis.go();
	}
