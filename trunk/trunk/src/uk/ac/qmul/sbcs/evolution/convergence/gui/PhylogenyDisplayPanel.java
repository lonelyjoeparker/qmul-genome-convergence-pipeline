 ...
 *
 */
public class PhylogenyDisplayPanel extends JPanel {
	 ...
	 */
	@Deprecated
	public PhylogenyDisplayPanel(){}
	
	/**
	 * @param coords - Specifies the start (X1, Y1) and end (X2, Y2) points in cartesian space of a list of lines. 
	 */
	public PhylogenyDisplayPanel(ArrayList<Integer[]> coords, ArrayList<String> names) {
