...
public class CongruenceRunner1000BinCDFMultiHnTestVariance {
	...
	public static void main(String[] args) {
		...
		taxaList.add("SOREX");
		MultiHnCongruenceAnalysisTestVariance analysis = new MultiHnCongruenceAnalysisTestVariance(dataSet, treeFileOne, treeFileTwo, treeFileThree, treeFileFour, workDir, binaries, runID, taxaList, replicatesForNull, thisFilter, doFactor);
		analysis.go();
	}
