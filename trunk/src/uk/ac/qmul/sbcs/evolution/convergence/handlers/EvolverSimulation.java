...
public class EvolverSimulation extends AbstractSequenceSimulation {
	...
	public void simulateNoArg() {
		...
		case DNA: 
			new VerboseSystemCommand("/Applications/Phylogenetics/PAML/paml44_myVersion/src/evolver 5 "+evolverDocumentFile.getAbsolutePath());
			break;
		case RNA:
			...
			break;
		case CODON: 
			new VerboseSystemCommand("/Applications/Phylogenetics/PAML/paml44_myVersion/src/evolver 6 "+evolverDocumentFile.getAbsolutePath());
			break;
		case AA: 
			new VerboseSystemCommand("/Applications/Phylogenetics/PAML/paml44_myVersion/src/evolver 7 "+evolverDocumentFile.getAbsolutePath());
			break;
