	...
	public void initialiseParameters(){
		if(this.initialisedWithSequenceType){
			...
			case CODON:
				...
				this.setParameter("AAFREQS","  0.00983798  0.01745548  0.00222048  0.01443315"+
			...
			default:
				...
				assert(false);
				this.setParameter("PAMLFLAG","");
				this.setParameter("SEED","");
				this.setParameter("NUM_SEQS",""); 
				this.setParameter("NUM_SITES",""); 
				this.setParameter("NREPS","");
				this.setParameter("TREE_LENGTH","");
				this.setParameter("TREE_STRING","");
			}
		}
	}
